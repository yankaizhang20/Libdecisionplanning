...
class CircleObstacle {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Circle.serialize(obj.circle, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.circle = Circle.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.circle !== undefined) {
      resolved.circle = Circle.Resolve(msg.circle)
    }
    else {
      resolved.circle = new Circle()
    }
