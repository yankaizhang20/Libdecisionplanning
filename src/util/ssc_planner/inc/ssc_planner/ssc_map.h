...
class SscMap {
    public:
        ...
        struct Config {
                ...
                void Print() {
                        ...
                        printf(" -- map_resolution: [%lf, %lf, %lf]\n", map_resolution[0], map_resolution[1],
                               map_resolution[2]);
                        printf(" -- axis_name: [%s, %s, %s]\n", axis_name[0].c_str(), axis_name[1].c_str(),
                               axis_name[2].c_str());
        ...
        vec_E<common::DrivingCorridor> driving_corridor_vec() const { return driving_corridor_vec_; }
    ...
    private:
        ...
        ErrorType GetTimeCoveredCubeIndices(const common::DrivingCorridor *p_corridor, const int &start_id,
