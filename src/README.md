...
rviz -d phy_simulator_planning.rviz       //rviz环境
```

3. Launch the planner's node and AI nodes:
```
roslaunch planning_integrated test_ssc_with_eudm_ros.launch   //eudm和ssc
roslaunch ai_agent_planner onlane_ai_agent.launch   //其他车辆共十个
```
