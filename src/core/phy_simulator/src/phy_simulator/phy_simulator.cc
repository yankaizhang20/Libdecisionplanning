...
PhySimulation::PhySimulation(const std::string &vehicle_set_path, const std::string &map_path,
...
bool PhySimulation::UpdateSimulatorUsingSignalSet(const common::VehicleControlSignalSet &signal_set,
                                                  const decimal_t &dt) {
...
bool PhySimulation::UpdateVehicleStates(const common::VehicleControlSignalSet &signal_set, const decimal_t &dt) {
        if (signal_set.signal_set.size() != vehicle_set_.vehicles.size()) {
                ...
                std::cerr << "[PhySimulation] signal_set num: " << signal_set.signal_set.size()
                          << ", vehicle_set num: " << vehicle_set_.vehicles.size() << std::endl;
                assert(false);
        }
