...
class Vehicle {
    ...
    private:
        ...
        std::string type_;
        VehicleParam param_;
        State state_;   //这里的的xy坐标指的是车辆后轴中心点的坐标
};
...
class TrafficSignal {
    public:
        TrafficSignal();
        TrafficSignal(const Vec2f &start_point, const Vec2f &end_point, const Vec2f &valid_time,
...
class SemanticsUtils {
    public:
        ...
        static ErrorType InflateVehicleBySize(const Vehicle &vehicle_in, const decimal_t delta_w,
